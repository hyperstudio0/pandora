...
//  mui
import {Box, Button, Card, CircularProgress, MenuItem, Stack, Tab, Tabs, Typography,} from '@mui/material';
...
export default function MainView() {
    ...
    return (
        ...
        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <CustomTabPanel value={value} index={0}>
                                        <CardList data={sampleData01} type={'OASYS'}/>
                                    </CustomTabPanel>

                                    {/* 탭 2 내용 */}
                                    <CustomTabPanel value={value} index={1}>
                                        <CardList data={sampleData02} type={'XPLA'}/>
                                        {status === WalletStatus.WALLET_CONNECTED && <Card
                                            sx={{
                                                display: 'flex',
                                                flexDirection: 'column',
                                                justifyContent: 'space-between',
                                        ...
                                        >
                                            <Typography variant="caption"
                                                        sx={{textAlign: 'center', mb:2}}>{wallets[0].xplaAddress}</Typography>
                                            {<Button
                                                variant="contained"
                                                color="inherit"
                                                size="small"
                                                onClick={() => disconnect()}>Disconnect XPLA Wallet</Button>}
                                        </Card>}
                                    </CustomTabPanel>

                                    {/* 탭 2 내용 */}
                                    <CustomTabPanel value={value} index={2}>
                                        <CardList data={sampleData03} type={'ETH'}/>
                                    </CustomTabPanel>

                                    {/* 탭 2 내용 */}
                                    <CustomTabPanel value={value} index={3}>
                                        <CardList data={sampleData04} type={'MATIC'}/>
                                    </CustomTabPanel>
                                </Box>
            ...
            {/* XPLA Wallet Status */}
            <Stack sx={{position: 'fixed', bottom: 0, opacity: 0.7}}>
                <Card sx={{p: 1}}>
                    <Typography sx={{fontSize: '0.7em'}}>
                        {'XPLA Status: '}{JSON.stringify(
                        {
                            status,
                            network,
                            wallets,
